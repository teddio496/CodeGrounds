...
const BlogPosts: React.FC = () => {
  ...
  const handleDelete = async (b_id: number) => {
    try {
      const response = await fetch(`/api/auth/protected/blog/delete-blog`, {
        method: "DELETE",
        headers: {
    ...
    <div className="dark:text-white">
      <div className="flex flex-col lg:w-3/5">
        ...
        <div className="sticky top-0 pl-3 dark:bg-[#333333] bg-white z-40">
          ...
          <h1 className="text-2xl p-3 font-bold ">My Blog Posts</h1>
      ...
      <div className="flex justify-between z-40">
        ...
        <div className="p-4 pt-0 space-y-4">
          <BlogList blogPosts={blogPosts} mine={true} handleDelete={handleDelete}/>
